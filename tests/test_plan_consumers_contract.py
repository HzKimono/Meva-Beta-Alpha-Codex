...
from btcbot.planning_kernel import Intent, OpenOrderView, PlanningContext, PlanningKernel
...
def test_plan_consumers_submit_plan_order_intents_in_same_order() -> None:
    """Contract test: consumers must preserve kernel-provided plan order."""
