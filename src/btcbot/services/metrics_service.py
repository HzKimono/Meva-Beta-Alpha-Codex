...
def build_cycle_metrics(
    ...
    *,
    mode: str,
    fills: list[Fill],
    fills_fetched_count: int,
    fills_persisted_count: int,
    ...
    return CycleMetrics(
        ...
        mode=mode,
        fills_count=max(0, int(fills_persisted_count)),
        ...
        meta={
            ...
            "fills_fetched_count": int(fills_fetched_count),
            "fills_persisted_count": int(fills_persisted_count),
