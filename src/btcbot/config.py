...
class Settings(BaseSettings):
    ...
    api_key_rotated_at: str | None = Field(default=None, alias="API_KEY_ROTATED_AT")
    secret_rotation_warn_days: int = Field(default=30, alias="SECRET_ROTATION_WARN_DAYS")
    secret_max_age_days: int = Field(default=90, alias="SECRET_MAX_AGE_DAYS")
    ...
    rounding_buffer_try: Decimal = Field(default=Decimal("0"), alias="ROUNDING_BUFFER_TRY")
    ...
    @field_validator("allocation_fee_buffer_bps", "fee_buffer_ratio", "rounding_buffer_try")
